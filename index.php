<?php get_header(); ?>
                    ...
                    <div class="swiper swiper-clientes">
                        ...
                        <div class="swiper-wrapper text-center">
                            ...
                            <div class="swiper-slide my-auto">
                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/clientes/logo-1.png" alt="" class="img-fluid" loading="lazy">
                            </div>
                            <div class="swiper-slide my-auto">
                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/clientes/logo-2.png" alt="" class="img-fluid" loading="lazy">
                            </div>
                            <div class="swiper-slide my-auto">
                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/clientes/logo-3.png" alt="" class="img-fluid" loading="lazy">
                            </div>
                            <div class="swiper-slide my-auto">
                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/clientes/logo-4.png" alt="" class="img-fluid" loading="lazy">
                            </div>
                            <div class="swiper-slide my-auto">
                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/clientes/logo-5.png" alt="" class="img-fluid" loading="lazy">
                            </div>
                            <div class="swiper-slide my-auto">
                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/clientes/logo-6.png" alt="" class="img-fluid" loading="lazy">
                            </div>
                            <div class="swiper-slide my-auto">
                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/clientes/logo-7.png" alt="" class="img-fluid" loading="lazy">
                            </div>
                            <div class="swiper-slide my-auto">
                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/clientes/logo-1.png" alt="" class="img-fluid" loading="lazy">
                            </div>
                ...
                <div class="col">
                    ...
                    <div class="swiper swiper-clientes-2">
                        ...
                        <div class="swiper-wrapper text-center">
                            <!-- Slides -->
                            <div class="swiper-slide my-auto">
                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/clientes-2/logo-1.webp" alt="" class="img-fluid" loading="lazy">
                            </div>
                            <div class="swiper-slide my-auto">
                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/clientes-2/logo-2.webp" alt="" class="img-fluid" loading="lazy">
                            </div>
                            <div class="swiper-slide my-auto">
                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/clientes-2/logo-3.webp" alt="" class="img-fluid" loading="lazy">
                            </div>
                            <div class="swiper-slide my-auto">
                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/clientes-2/logo-4.webp" alt="" class="img-fluid" loading="lazy">
                            </div>
                            <div class="swiper-slide my-auto">
                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/clientes-2/logo-5.webp" alt="" class="img-fluid" loading="lazy">
                            </div>
                            <div class="swiper-slide my-auto">
                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/clientes-2/logo-6.webp" alt="" class="img-fluid" loading="lazy">
                            </div>
                            <div class="swiper-slide my-auto">
                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/clientes-2/logo-7.webp" alt="" class="img-fluid" loading="lazy">
                            </div>
                            <div class="swiper-slide my-auto">
                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/clientes-2/logo-8.webp" alt="" class="img-fluid" loading="lazy">
                            </div>
                            <div class="swiper-slide my-auto">
                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/clientes-2/logo-9.webp" alt="" class="img-fluid" loading="lazy">
                            </div>
                            <div class="swiper-slide my-auto">
                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/clientes-2/logo-1.webp" alt="" class="img-fluid" loading="lazy">
                            </div>
    ...
    <section id="video">
        <iframe class="video" src="https://www.youtube.com/embed/u31qwQUeGuM?si=QuLmzlcrGEXuF_Du" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    </section>
